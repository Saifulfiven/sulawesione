                      ...
                      @foreach ($provinsis as $provinsi)
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="{{ url('admin/provinsi/ubah/'.$provinsi->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ url('admin/provinsi/hapus/'.$provinsi->id) }}" class="btn btn-sm btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      @endforeach
