        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-header pb-0 position-relative mb-5">
              <h6>Data Berita</h6>
              <a href="{{ url('admin/berita/tambah') }}" class="btn btn-success position-absolute end-0 top-0 mt-3 me-3">Tambah berita</a>
            </div>
                      ...
                      @foreach ($beritas as $berita)  
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="{{ url('admin/berita/ubah/'.$berita->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ url('admin/berita/hapus/'.$berita->id) }}" class="btn btn-sm btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      @endforeach
