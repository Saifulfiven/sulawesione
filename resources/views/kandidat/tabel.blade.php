        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-header pb-0 position-relative mb-5">
              <h6>Data kandidat</h6>
              <a href="{{ url('admin/kandidat/tambah') }}" class="btn btn-success position-absolute end-0 top-0 mt-3 me-3">Tambah kandidat</a>
            </div>
                      ...
                      @foreach ($kandidat as $kandidat)  
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="{{ url('admin/kandidat/ubah/'.$kandidat->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ url('admin/kandidat/hapus/'.$kandidat->id) }}" class="btn btn-sm btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      @endforeach
