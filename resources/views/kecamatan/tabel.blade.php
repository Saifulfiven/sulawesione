        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-header pb-0 position-relative mb-5">
              ...
              <a href="{{ url('admin/kecamatan/tambah') }}" class="btn btn-success position-absolute end-0 top-0 mt-3 me-3">Tambah kecamatan</a>
            </div>
                ...
                <table class="table align-items-center mb-0" id="tabel-data">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary">Nama Kecamatan</th>
                      <th class="text-secondary">Nama Kabupaten</th>
                    ...
                    <tbody>
                      ...
                      @foreach ($kecamatans as $kecamatan)  
                        <tr>
                          ...
                          <td>{{ $kecamatan->namakabupaten }}</td>
                          <td>{{ $kecamatan->created_at }}</td>
                          <td class="text-center">
                            <a href="{{ url('admin/kecamatan/ubah/'.$kecamatan->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ url('admin/kecamatan/hapus/'.$kecamatan->id) }}" class="btn btn-sm btn-danger">Hapus</a>
                          </td>
                        </tr>
                        <?php $no++; ?>
                      @endforeach
