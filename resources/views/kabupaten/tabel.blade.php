        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-header pb-0 position-relative mb-5">
              <h6>Data Kabupaten</h6>
              <a href="{{ url('admin/kabupaten/tambah') }}" class="btn btn-success position-absolute end-0 top-0 mt-3 me-3">Tambah kabupaten</a>
            </div>
                    ...
                    <tbody>
                      ...
                      @foreach ($kabupatens as $kabupaten)  
                        <tr>
                          ...
                          <td>{{ $kabupaten->namaprovinsi }}</td>
                          <td>{{ $kabupaten->created_at }}</td>
                          <td class="text-center">
                            <a href="{{ url('admin/kabupaten/ubah/'.$kabupaten->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ url('admin/kabupaten/hapus/'.$kabupaten->id) }}"
